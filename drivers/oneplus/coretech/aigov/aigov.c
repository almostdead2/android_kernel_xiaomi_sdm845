...
/* global resource - SDM845: 2 clusters */
static int g_cpufreq[2] = {0};
static int g_ddrfreq = 0;
static atomic_t g_boost_hint[2] = {ATOMIC_INIT(0)};
...
{
	aigov_logv("cpu%d %d cpu%d %d ddrfreq %d boost %d %d\n",
...
/* test trigger entry - SDM845: only 2 clusters */
